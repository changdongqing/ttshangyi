...
using TTShang.Framework.AspNetCore;
using TTShang.Framework.AspNetCore.Authentication.OAuth;
using TTShang.Framework.AspNetCore.Authentication.OAuth.Gitee;
using TTShang.Framework.AspNetCore.Authentication.OAuth.QQ;
using TTShang.Framework.AspNetCore.Microsoft.AspNetCore.Builder;
using TTShang.Framework.AspNetCore.Microsoft.Extensions.DependencyInjection;
using TTShang.Framework.AspNetCore.UnifyResult;
using TTShang.Framework.BackgroundWorkers.Hangfire;
using TTShang.Framework.Core.Json;
...
using TTShang.Framework.Rbac.Domain.Shared.Options;
using TTShang.Framework.TenantManagement.Application;

namespace TTShang.Abp.Web
{
    [DependsOn(
        ...
        public override Task ConfigureServicesAsync(ServiceConfigurationContext context)
        {
            ...
            context.Services.AddYiSwaggerGen<YiAbpWebModule>(options =>
            {
                options.SwaggerDoc("default",
                    new OpenApiInfo { Title = "TTShang.Framework.Abp", Version = "v1", Description = "集大成者" });
            });
