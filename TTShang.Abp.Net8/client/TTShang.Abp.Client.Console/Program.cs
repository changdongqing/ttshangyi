...
using TTShang.Abp.Client.Console;
...
try
{
    ...
    //登录
    var data2 = await account.PostLoginAsync(new TTShang.Framework.Rbac.Application.Contracts.Dtos.Account.LoginInputVo { UserName = "cc", Password = "123456", Code = string.Empty, Uuid = string.Empty });
