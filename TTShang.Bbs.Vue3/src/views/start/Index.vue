...
const installText = "> dotnet tool install -g TTShang.Abp.Tool";
...
<template>
    <div class="start-body">
        ...
        <div class="content">
            ...
            <div class="version">TTShang.Abp.Tool工具集，最新版本号 {{ nugetData.versions }}，当前总下载次数 {{nugetData.downloadNumber}}</div>
            </div>
            <div class="content-body">
                <div class="content-body-left">
                    <h4>安装 TTShang.Abp.Tool</h4>
                    <p>如果之前未安装 TTShang.Abp.Tool，请在命令行终端中安装：</p>
                    <CodeBox  v-model="installText" />

                    <h4>克隆源代码，yi框架非打包，便于大家调试二开</h4>
                    <p>需安装git及TTShang.Abp.Tool，执行命令：</p>
